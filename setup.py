...
setup(
    ...
    url="https://github.com/MozaicWorks/DownloadDMARCAttachmentsFromGmail",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Mozaic Works",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="alex.bolboaca@mozaicworks.com",  # Optional
